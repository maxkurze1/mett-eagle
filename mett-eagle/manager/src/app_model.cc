 ...
 *
 * This method allocates a Dataspace kernel object and then
                         ...
                         "allocating region-map cap"))
{
  ...
  L4Re::chksys (alloc->create (_rm), "allocating new region map");
 ...
 *
 * The factory will be used to create the task and the thread
 *
                          ...
                          L4::Cap<L4::Task> *task, L4::Cap<L4::Thread> *thread)
{
  ...
  *thread = _thread;
  *factory
      = L4::Cap<L4::Factory> (prog_info ()->factory.raw & L4_FPAGE_ADDR_MASK);
}
